...
namespace Lab3_OOP.Controllers
{
    public class ProfessionsController : Controller
    {
        ...
        {
            return View(await _context.Klempner.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var profession = await _context.Klempner
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var profession = await _context.Klempner.FindAsync(id);
            if (profession == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (profession != null)
            {
                _context.Klempner.Remove(profession);
            }
